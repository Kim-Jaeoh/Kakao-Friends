...
import kakaoLogo from "../image/logo_foot_kakao.png";
import markLogo from "../image/mark_info.png";

const Container = styled.footer`
  line-height: 20px;
  font-family: "Apple SD Gothic Neo", "Nanum Gothic", sans-serif !important;

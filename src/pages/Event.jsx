            ...
            <Container>
              ...
              <InfoTextBox>
                ...
                <InfoText>
                  ...
                  <li>
                    ∙ 할로윈 LED 가랜드 이벤트 적용 오프라인 스토어 :
                    카카오프렌즈 강남 플래그십 스토어, 카카오프렌즈 홍대
                    플래그십 스토어, 홍대 팩토리 스토어, 카카오프렌즈 부산
                    플래그십 스토어, 롯데월드몰 잠실점, 롯데 영플라자 명동점,
                    롯데 프리미엄 아울렛 기흥점, 신세계 백화점 동대구점,
                    스타필드 코엑스점, 스타필드 고양점, DDP 동대문점, 영등포
                    타임스퀘어점, 수원 AK점, 대전 갤러리아 타임월드점, 전주
                    한옥마을점, JPC 제주 프리미엄 전문점, 판교 사내 스토어
                  </li>
